...
Para testar este exercício, basta os arquivos HTML em um navegador moderno (Chrome, Firefox, Edge, Opera, Safari, Konqueror ou Samsung Internet) e ver o se o que aparece na tela está similar às imagens providas como resultados desejados.
...
- Teste no Chrome e no Firefox para evitar possíveis diferenças entre navegadores. Se quiser ir além, teste também no Edge, no Opera, no Safari, no Konqueror e/ou no Samsung Internet também.
...
- Em geral, com pouquíssimas exceções, existe uma relação de um-para-um entre as regras numeradas entre colchetes nos enunciados e as regras CSS que vocês vão definir.
